...
const raisedToTheThird = (arr) => {
    ...
    let newArry = [] ;
    arr.forEach(element => {
        newArry.push(Math.pow(element , 3))
...
Write a function that accepts an object and an integer as arguments and adds a new property to the object called obj. The value of the yearBorn property should be the integer that was passed in.
